...
//
//        // 8. Extract Image /*Commented on 26 Feb 2021, as crashing on image decode*/
    ...
    protected void decodeData(List<byte[]> encodedData) throws QrCodeException {
        ...
        scannedAadharCard.setUuid(decodedData.get(1));
...
/*
    public void parseXml(String scanData) {
        ...
        try {
            ...
            is.setCharacterStream(new StringReader(scanData));
            try {
                Document doc = db.parse(is);
                String uid = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_UID_ATTR);
                String name = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_NAME_ATTR);
                String gender = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_GENDER_ATTR);
                String dob = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_DOB_ATTR);
                String yob = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_YOB_ATTR);
                String careof = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_CO_ATTR);
                String vtc = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_VTC_ATTR);
                String postoffice = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_PO_ATTR);
                String district = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_DIST_ATTR);
                String landmark = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_LAND_ATTR);
                String house = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_HOUSE_ATTR);
                String location = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_LOCATION_ATTR);
                String state = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_STATE_ATTR);
                String pincode = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_PC_ATTR);
                String street = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_STREET_ATTR);
                String subdistrict = doc.getDocumentElement().getAttribute(DataAttributes.AADHAR_SUBDIST_ATTR);

                scannedAadharCard.setName(name);
                scannedAadharCard.setDateOfBirth(dob);
                scannedAadharCard.setGender(gender);
                scannedAadharCard.setCareOf(careof);
                scannedAadharCard.setDistrict(district);
                scannedAadharCard.setLandmark(landmark);
                scannedAadharCard.setHouse(house);
                scannedAadharCard.setLocation(location);
                scannedAadharCard.setPinCode(pincode);
                scannedAadharCard.setPostOffice(postoffice);
                scannedAadharCard.setState(state);
                scannedAadharCard.setStreet(street);
                scannedAadharCard.setSubDistrict(district);
                scannedAadharCard.setVtc(vtc);
                scannedAadharCard.setUuid(uid);
                scannedAadharCard.setSubDistrict(subdistrict);
                scannedAadharCard.setYearOfBirth(yob);
